...
class ModelArguments:
    ...
    with_out_distributed: bool = field(default=True)
...
def train():
    ...
    if model_args.with_out_distributed or training_args.local_rank == 0:
    ...
    if not model_args.with_out_distributed and training_args.local_rank == 0:
        torch.distributed.barrier()
